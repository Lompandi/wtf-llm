...
def _prompt(entry: FuzzEntry, code: str, extra: str) -> str:
    return (
        ...
        f"forms, chosen from the WIDTH the code reads at. Omit for `bytes`.\n"
        ...
        f"For a `magic` field give magic_value as an integer.\n"
        f"For the `bytes` field give max_length, a sane upper bound.\n\n"
        f"Also decide:\n"
